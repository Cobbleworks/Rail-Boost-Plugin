<p align="center">
  ...
  <img src="images/plugin-logo.png" alt="Rail Boost" width="180" />
</p>
...
- **Speed Control:** Six configurable speed levels (0.25Ã— to 4.0Ã—) with intelligent physics handling for curves, uphill sections, and speed transitions
- **Auto-Pickup System:** Automatic item collection within a configurable radius (1â€“5 blocks) with per-cart blacklist filtering for precise control
...
- **Preset System:** Create, save, and share named minecart configurations using sticks â€” apply saved presets to any cart via right-click
- **Predefined Presets:** Three built-in standard presets for common use cases â€” Speed, Collector, and Magnet configurations
